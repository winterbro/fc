...
<div id="video-bg">
  <video id="background-video" muted autoplay loop poster="<?php bloginfo('template_directory'); ?>/assets/videobg/background.png">
    ...
    <div class="landing-message">
        <div class="landing-message-text text-center">
          <h1>FLYING COUCH</h1>
          <p>EST. 2014</p>
          <br><br>
          <a href="/filmen/" class="ghost-butt">WATCH OUR FILM</a>
        </div>
    </div>
</section>
...
<section class="welcome">
    <div class="col-lg-5 text-center center">
      ...
      Today Flying Couch Brewing consists of 5 members with the additions of Kasper Gerdes, Kim Christiansen & Michael Aaron.
      </p>
      <p>
...
<section class="brewery">
  <div class="col-lg-10 brewery-wrap center">
